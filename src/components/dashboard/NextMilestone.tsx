  ...
  return (
    <div className="glass-card rounded-[2.5rem] p-8 shadow-xl relative overflow-hidden">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 className="font-display text-sm font-black text-foreground">Mốc tiếp theo</h3>
          <p className="text-[10px] text-muted-foreground/60 font-medium">Mục tiêu ngắn hạn</p>
        </div>
      </div>
