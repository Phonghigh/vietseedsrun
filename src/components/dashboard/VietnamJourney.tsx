    ...
    <div className="glass-card rounded-[3rem] p-10 md:p-14 shadow-2xl relative overflow-hidden flex flex-col">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-12 mb-20 relative z-10 font-bold">
        <div className="max-w-3xl">
          ...
          <p className="text-foreground font-black leading-relaxed text-xl md:text-2xl max-w-3xl border-l-[6px] border-primary pl-8 py-2 italic">
            {currentKm.toLocaleString()} km đã được chinh phục - tương đương
            hành trình từ{" "}
      ...
      <div className="flex flex-col lg:flex-row gap-20 items-stretch min-h-[800px]">
        ...
        <div className="flex-1 bg-gradient-to-b from-secondary to-background rounded-[4.5rem] p-10 md:p-14 border border-primary/20 overflow-hidden flex items-center justify-center relative group">
          ...
          <svg
            viewBox="40 -80 240 600"
            className="h-[800px] w-auto transition-all duration-1000 hover:scale-[1.02]"
                  ...
                  >
                    <circle
                      ...
                      r={
                        city.name === "TP.HCM"
                          ? 14
                          : ["Hà Nội", "Cà Mau"].includes(city.name)
                            ? 10
                            : 7
                      }
                      fill={
                ...
                >
                  ...
                  >
                    <div className="bg-white border-2 border-primary/30 rounded-2xl px-5 py-4 text-center shadow-2xl flex flex-col justify-center min-h-[85px]">
                      <div className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest leading-tight mb-2">
                        Khoảng cách còn lại
                      </div>
          ...
          <div className="bg-secondary border border-primary/30 rounded-[3.5rem] p-10 flex-1 flex flex-col justify-center relative overflow-hidden group/card hover:border-primary/50 transition-all duration-700 shadow-2xl">
            ...
            <div className="text-center mb-12 relative flex flex-col items-center">
              ...
              <div className="inline-flex items-center bg-white border-2 border-primary/20 px-10 py-5 rounded-full text-3xl font-black text-primary shadow-2xl ring-4 ring-primary/5 tabular-nums">
                ...
                <span className="text-xs ml-3 text-muted-foreground uppercase tracking-widest font-black">
                  KM
                </span>
              </div>
            </div>
              ...
              >
                ...
                <div className="flex items-center justify-center gap-6 text-primary mb-5 relative">
                  ...
                  <span className="font-display text-5xl font-black tracking-tight text-foreground tabular-nums">
                    {remaining.toLocaleString()}{" "}
                    <span className="text-lg text-primary font-black">KM</span>
                  </span>
                </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-5">
          {CITIES.map((city, i) => {
            ...
            return (
              ...
              >
                <div
                  className={`w-12 h-12 rounded-xl mx-auto mb-4 flex items-center justify-center text-xs font-black transition-all ${
                    reached
                ...
                <div className="text-[11px] font-black uppercase tracking-[0.15em] truncate mb-1 italic">
                  {city.name}
                </div>
                <div
                  className={`text-base font-display font-black tabular-nums ${reached ? "text-primary" : "text-foreground/40"}`}
                >
                  {city.km.toLocaleString()}{" "}
                  <span className="text-[10px] ml-1 opacity-60">KM</span>
                </div>
                {reached ? (
                  <div className="text-[9px] font-black mt-3 text-primary tracking-[0.2em] bg-white px-2 py-0.5 rounded-full border border-primary/20 shadow-sm">
                    HOÀN THÀNH✓
                  </div>
                ) : (
                  <div className="text-[9px] font-black mt-3 text-muted-foreground/30 tracking-[0.2em] uppercase">
                    Đang đợi
                  </div>
                )}
              </div>
